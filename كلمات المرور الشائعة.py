...
def generate_wordlist():
    ...
    # 2. Number Sequences
    number_sequences = [
        '112233445566', '1122334455','123456', '12345','11223344', '112233',
        '123123', '123456789', '12345678', '1234567', '332211', '654321', '987654321', '102030', '2030',
    ]
    # 3. Single Symbols
    symbols = ['!', '@', '#', '$']
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output',default='passwords.txt' ,type=str, help='Output filename (e.g., wordlist.csv or wordlist.txt)')
